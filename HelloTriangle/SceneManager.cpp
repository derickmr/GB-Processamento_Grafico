...
void SceneManager::render()
{
	...
	//Desenhando 25 tiles aleatoriamente na tela

	for (int i = 0; i < 25; i++)
	{
		glm::mat4 model = glm::mat4();
		model = glm::translate(model, glm::vec3(rand()%800, rand()%600, 0.0));  //posX e posY da tela
		tileset[rand()%2].draw(model);
	}
...
void SceneManager::setupScene()
{
	...
	tile.setCor(0.1, 0.5, 0.1);
	tile.inicializar(64, 128);
	tileset.push_back(tile);

	tile.setCor(0.5, 0.2, 0.1);
	tile.inicializar(64, 128);
	tileset.push_back(tile);
}
...
void SceneManager::setupTexture()
{
	...
	/*glm::vec3 cor(255, 255, 0);

	for (int i = 0; i < width * height* nrChannels; i += 4)
	{
		unsigned char c = data[i] * 0.2125 + data[i + 1] * 0.7154 + data[i + 2] * 0.0721;
